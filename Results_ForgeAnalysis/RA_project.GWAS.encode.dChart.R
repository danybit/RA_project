...
d1 <- dPlot(
  ...
  id = 'chart.RA_project.GWAS.encode'
)
...
//       });
    ...
    myChart.svg.append('text')
      ...
      .text('DMPs in DNase I sites (probably TF sites) in cell lines for encode RA_project')
    ", labels.string, "
    ", lines.string, "
...
d1$save('RA_project.GWAS.encode.dchart.html', cdn = F)
